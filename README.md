...
- **Raw FASTQ** **files** are available at Sequence Read Archive (SRA) under the [PRJNA1356374]([https://www.ncbi.nlm.nih.gov/sra/PRJNA1356374](https://www.ncbi.nlm.nih.gov/sra/PRJNA1356374))
- **Processed data**, including count matrices, cell-level metadata, and annotated Seurat objects, are available at Gene Expression Omnibus [GEO – pending accession number]. Count matrices and cell-level metadata aredata also available in [data](../data).
