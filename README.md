...
Raw data were processed with *Cell Ranger v9.0.1*, and downstream analyses were performed using ***[scStudio](https://www.biorxiv.org/content/10.1101/2025.04.17.649161v1)***  and custom [R scripts](.scripts/).
...
- **Processed data**, including count matrices, cell-level metadata, and annotated Seurat objects, are available at Gene Expression Omnibus (GEO) (pending accession number). Count matrices and cell-level metadata are also available in [data](.data/).
